  ...
  parts: [
    {
      ...
      moves: [
        ...
        { name: "لانج متناوب سبک", reps: "هر طرف چند بار", cues: ["پای عقب دوباره برمی‌گرده", "اگه فشار داره، ورژن کوتاه‌تر (بالا-پایین جزئی)"], video: { file: "Warm-up1", t: "00:03:16", end: "00:04:10" } },
        { name: "ایروبیک سبک (Zone 2)", reps: "۲–۳ دقیقه", cues: ["تردمیل/طناب/مارش/موزیک — هرچی داری", "باید بتونی حرف بزنی بدون نفس‌نفس زدن"], video: { file: "Warm-up1", t: "00:04:10", end: "00:06:39" } },
        ...
        { name: "گردن: بالا و پایین (چانه)", reps: "چند تکرار", cues: ["فقط چونه میاد، گردن خم نمی‌شه", "با کنترل، بدون حرکت شلاقی"], video: { file: "Warm-up1", t: "00:07:14", end: "00:07:34" } },
        { name: "گردن: نیم‌دایره جلو و عقب", reps: "چند تکرار هرکدام", cues: ["در تمام مسیر نقطه‌کور رو دنبال کن"], video: { file: "Warm-up1", t: "00:07:34", end: "00:08:44" } },
        { name: "شونه: دایره بازو رو به جلو", reps: "چند تکرار", cues: ["کتف از پشت همراه دست بالا بیاد", "بالا: کف دست به هم؛ پایین: کف دست به پا"], video: { file: "Warm-up1", t: "00:08:44", end: "00:09:41" } },
        { name: "شونه: دایره بازو معکوس", reps: "چند تکرار", cues: ["دایره معمولی، نه خیلی بزرگ", "دست از راستای بدن جلو نیاد"], video: { file: "Warm-up1", t: "00:09:41", end: "00:09:52" } },
    ...
    },
    {
      ...
      moves: [
        ...
        { name: "مهره وسط (نشسته)", reps: "۱۰–۱۵ تکرار", cues: ["شونه‌ها ثابت، کتف بیفته، گودی کمر ایجاد کن"], video: { file: "Warm-up2", t: "00:04:55", end: "00:05:50" } },
        { name: "Open Book (چرخش ستون فقرات میانی)", reps: "هر طرف (+ اختیاری با کش)", cues: ["چرخش از مهره‌های وسط (۶ تا ۱۷/۱۸)، نه از پایین", "نگاهت کف دستتو دنبال کنه", "برای دیسک کمر مضر نیست اگه درست انجام بشه"], video: { file: "Warm-up2", t: "00:05:50", end: "00:07:46" } },
        { name: "نسخه نشسته با تمرکز شونه", reps: "هر طرف (+ اختیاری با کش)", cues: ["لگن سمت دیوار بچسبه به دیوار", "نگاهت دستتو دنبال کنه"], video: { file: "Warm-up2", t: "00:07:46", end: "00:09:00" } },
    ...
    },
    {
      ...
      moves: [
        { name: "ترکیب چندجهته لگن روی زمین", reps: "۵ تکرار هر طرف", cues: ["جلو، عقب و چرخش رو با هم در یک مسیر انجام بده"], video: { file: "Warm-up3", t: "00:00:07", end: "00:01:02" } },
        { name: "همون حرکت با فوم رول / دیوار (ساپورت)", reps: "۵ تکرار هر طرف", cues: ["اگه فوم رول نداری، نسخه نشسته رو بیشتر کار کن"], video: { file: "Warm-up3", t: "00:01:02", end: "00:01:50" } },
        { name: "چرخش لگن ایستاده (پنجه رو‌به‌رو)", reps: "چند تکرار", cues: ["بالاتنه ثابت بمونه، فقط لگن/مچ/زانو بچرخه", "زانوها ۹۰ درجه می‌چرخه"], video: { file: "Warm-up3", t: "00:01:50", end: "00:02:32" } },
        ...
        { name: "پل باسن", reps: "چند تکرار", cues: ["گودی کمر رو بالا نیار، احساس کن پشت پا هم منقبض می‌شه"], video: { file: "Warm-up3", t: "00:05:53", end: "00:06:53" } },
        { name: "اسکوات اورهد (دامنه محدود تا ۹۰°)", reps: "چند تکرار", cues: ["بازو از گوش جدا نشه", "بدن جلو نیاد، گودی کمر زیاد نشه"], video: { file: "Warm-up3", t: "00:06:53", end: "00:07:28" } },
        { name: "هیپ هینج تمرینی (با چوب/دیوار/فوم‌رول)", reps: "چند تکرار", cues: ["خم‌شدن از کمر بدون قوس کردن کمر"], video: { file: "Warm-up3", t: "00:07:28", end: "00:08:48" } },
...
function VideoBadge({ video }) {
  ...
  const endSec = video.end ? timeToSeconds(video.end) : null;
  const src = `https://www.youtube.com/embed/${videoId}?start=${startSec}${endSec ? `&end=${endSec}` : ""}&autoplay=1&rel=0`;
  ...
  return (
    <div className="relative inline-block">
      ...
      >
        {hasLink ? <PlayCircle size={12} /> : <Film size={12} />} ویدیوی حرکت
      </button>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between p-3">
              <span className="text-xs" style={{ color: C.textMuted }}>ویدیوی حرکت</span>
